...
public class FragmentBreathFreq extends Fragment{
	...
	private void init(View view)
	{
		...
		LinearLayout linearView = (LinearLayout) view.findViewById(R.id.chart_show);
        hello = ChartFactory.getCubeLineChartView(getActivity(), mDataset, renderer,0.1f);
		linearView.addView(showDraw(getActivity()),layout);
