...
/**********************************************************************
 * 类名：EmailAutoCompleteTextView
 * 
 * 主要功能：使用AutoCompleteTextView实现邮箱地址自动补全
 * 
 * @author 梁才学 创建日期：2014.2.12
 **********************************************************************/
public class EmailAutoCompleteTextView extends AutoCompleteTextView {
	private static final String TAG = "EmailAutoCompleteTextView";

	private String[] emailSufixs = new String[] { "@126.com", "@139.com",
			"@189.cn", "@163.com", "@qq.com", "@sohu.com", "@hotmail.com",
			"@sina.com", "@yahoo.com.cn", "@yahoo.com" };
	...
	private void init(final Context context) {
		...
		this.setThreshold(1);// 使得在输入1个字符之后便开启自动完成
		this.setOnFocusChangeListener(new OnFocusChangeListener() {// 监听焦点
			...
			public void onFocusChange(View v, boolean hasFocus) {
				if (hasFocus) {
					...
					if (text != null
						...
						// i.setBackgroundResource(R.drawable.right);
						// toast.setView(i);
						// toast.show();
					} else {
						// 当失去焦点时，提示
