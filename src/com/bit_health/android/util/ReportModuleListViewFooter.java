...
public class ReportModuleListViewFooter extends LinearLayout {
	...
	public ReportModuleListViewFooter(Context context) {
		super(context);
		initView(context);
	}

	public ReportModuleListViewFooter(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	}
